...
const Navbar = ({ activePage = '', visible = true, className = '' }) => {
  ...
  const defaultMenuItems = [
    { _id: '1', label: 'Beranda', url: '/', isDropdown: false, children: [] },
    {
      ...
      isDropdown: true,
      children: [
        { _id: 'profil-1', label: 'Tentang Kami', url: '/page/profil#tentang-kami', target: '_self' },
        { _id: 'profil-2', label: 'Visi & Misi', url: '/page/profil#visi-misi', target: '_self' },
        { _id: 'profil-3', label: 'Sejarah', url: '/page/profil#sejarah', target: '_self' },
        { _id: 'profil-4', label: 'Struktur Organisasi', url: '/page/profil#struktur-organisasi', target: '_self' },
      ]
    },
